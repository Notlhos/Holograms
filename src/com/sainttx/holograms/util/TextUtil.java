...
public class TextUtil {
	 ...
	 *
	 * @param location
	 *            A location to be converted
	 * @return A string representation of the Location
	 */
	public static String locationAsString(Location location) {
		return location.getWorld().getName() + " (x/y/z: " + formatDouble(location.getX()) + "/" + formatDouble(location.getY()) + "/" + formatDouble(location.getZ()) + ")";
	}

	/**
	 * Returns a formatted String representation of a double, rounded to 2 decimal places
	 *
	 * @param value
	 ...
	 *             when an invalid amount or durability are provided
	 * @throws IllegalArgumentException
	 *             when an invalid material or enchantment is provided
	 */
	 ...
	 *
	 * @param startIndex
	 *            The start index of the String array to implode
	 * @param toImplode
	 *            The String array to implode
	 * @return An imploded string joined by spaces
	 */
