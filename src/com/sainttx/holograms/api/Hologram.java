...
public class Hologram {
	...
	/**
	 * Sets this Holograms dirty state. A "dirty" Hologram implies that since the last time it was saved, the Hologram has had some sort of modification performed to it and requires the plugin to save it to reflect any changes. If the Hologram is not
	 * persistent, it will always remain dirty unless modified by a third party. This is due to the plugin never saving it.
	 *
	 * @param dirty
	 *            the dirty state
	 */
	 ...
	 *             if the line is not part of this hologram
	 */
