...
public interface HologramManager {
	...
	/**
	 * Permanently deletes a {@link Hologram}. This method will despawn and remove the hologram as active.
	 *
	 * @param hologram
	 *            the hologram
	 */
	...
	/**
	 * Gets a {@link Hologram} by its unique name. If the hologram does not exist then <code>null</code> will be returned.
	 *
	 * @param name
	...
	/**
	 * Registers a {@link Hologram} to the manager. If the user wishes for the hologram to have persistence, then the {@link #saveHologram(Hologram)} method should be called.
	 * <p>
	 * The hologram will be available in {@link #getActiveHolograms()} after calling this method.
	 *
	 * @param hologram
	 *            the hologram
	 */
	...
	/**
	 * Tracks an updating hologram line for execution of {@link UpdatingHologramLine#update()} by the plugins internal scheduler.
	 *
	 * @param line
	 *            the line to track.
	 */
	 ...
	 * @param line
	 *            the line
	 * @return <tt>true</tt> if the line was removed from the collection returned by {@link #getTrackedLines()}
	 */
